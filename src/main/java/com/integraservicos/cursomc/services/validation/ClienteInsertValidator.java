...
import com.integraservicos.cursomc.dto.ClienteNewDTO;
...
import com.integraservicos.cursomc.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto,ConstraintValidatorContext context){
		...
		if(aux != null)
		{
			list.add(new FieldMessage("cpfOuCnpj", "Email já cadastrado"));
		}
